...
export class UserCertificationRelation1672806546227
  implements MigrationInterface
{
  name = 'UserCertificationRelation1672806546227';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_4e90ed5064cf1d34505e47ddd8" ON "user_certification" ("userId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user_certification" DROP CONSTRAINT "FK_31eee85b3a0aa36c91e92ec71df"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_certification" DROP CONSTRAINT "FK_4e90ed5064cf1d34505e47ddd8d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_31eee85b3a0aa36c91e92ec71d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4e90ed5064cf1d34505e47ddd8"`,
    );
...
export class UserCertificationRelation1672806546227 implements MigrationInterface {
    name = 'UserCertificationRelation1672806546227'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "certification" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, CONSTRAINT "PK_a7364bd3e4a407f67d8165b820c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_certification" ("userId" integer NOT NULL, "certificationId" integer NOT NULL, CONSTRAINT "PK_8dae0a94680202a877753c30e67" PRIMARY KEY ("userId", "certificationId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_4e90ed5064cf1d34505e47ddd8" ON "user_certification" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_31eee85b3a0aa36c91e92ec71d" ON "user_certification" ("certificationId") `);
        await queryRunner.query(`ALTER TABLE "user_certification" ADD CONSTRAINT "FK_4e90ed5064cf1d34505e47ddd8d" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "user_certification" ADD CONSTRAINT "FK_31eee85b3a0aa36c91e92ec71df" FOREIGN KEY ("certificationId") REFERENCES "certification"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
...
>>>>>>> 5cb3f86 (certification get route is done and also integrate api into client side and generate migration)
}
