...
export class routeTables1678124495036 implements MigrationInterface {
    name = 'routeTables1678124495036'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "route_points" ("id" SERIAL NOT NULL, "key" character varying NOT NULL, "type" character varying NOT NULL, "name" character varying NOT NULL, "position" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9684d129d71ff38906e7cb08c68" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "route" ("id" SERIAL NOT NULL, "altitude" integer NOT NULL, "useForecastWinds" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "destinationId" integer, "departureId" integer, "userId" integer, CONSTRAINT "PK_08affcd076e46415e5821acf52d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "route_points" DROP COLUMN "position"`);
        await queryRunner.query(`ALTER TABLE "route_points" ADD "position" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "route" ADD CONSTRAINT "FK_5f1f8af943496a71fa29f6a44f9" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
