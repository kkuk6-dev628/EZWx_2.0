...
function Meteogram() {
  ...
  const [airportwxState, setAirportwxState] = useState(airportwxDbState);
      ...
      <div className="route-profile-container">
        <div className="route-profile-header">
          ...
          <div className="header-right">
            ...
            {airportwxState.chartType === routeProfileChartTypes.wind && (
                    ...
                    {Object.entries(routeProfileWindDataTypes).map(([key, value]) => {
                      return (
                        <RadioButton
                          ...
                          value={value}
                          title={value}
                          selectedValue={airportwxState.windLayer}
                          description=""
